...
public class ABanka extends Banka{


    private int taksitSayiA;

    public int getTaksitSayiA(){
        return taksitSayiA;
    }
    public void setTaksitSayiA(int taksitSayiA ){
        this.taksitSayiA = taksitSayiA;
    }
